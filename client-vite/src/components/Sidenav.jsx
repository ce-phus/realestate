...
const Sidenav = forwardRef(({ isSidebarOpen }, ref) => {
  ...
  return (
    <div>
      <aside id='logo-sidebar' ref={ref} className={`fixed top-14 left-0 z-20 w-64 h-screen pt-10 transition-transform bg-white border-r border-gray-300 sm:translate-x-0 dark:bg-dark dark:border-gray-700 ${isSidebarOpen ? 'translate-x-0' : '-translate-x-full'}`} aria-label='Sidebar' role="navigation">
        <div className='h-full px-3 overflow-y-auto'>
          ...
          <ul className='space-y-2 font-medium'>
            ...
            <li>
              <button onClick={handleLogout} className="flex dark:text-white gap-4  px-1 py-1.5 rounded-lg hover:bg-gray-300 dark:hover:bg-gray-700 cursor-pointer">
