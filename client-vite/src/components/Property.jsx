...
const Property = ({ property }) => {
  ...
  return (
    <div className='mx-3 md:mx-0'>
        <Link className='flex flex-col items-center bg-white border border-gray-200 rounded-lg shadow md:flex-row md:max-w-7xl dark:bg-dark dark:border-gray-700' to="">
